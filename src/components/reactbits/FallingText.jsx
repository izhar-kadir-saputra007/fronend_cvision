...
const FallingText = ({
  ...
  useEffect(() => {
    ...
    const newHTML = words
      .map((word) => {
        ...
        return `<span
          class="inline-block mx-[2px] select-none ${isHighlighted ? "text-color1 font-bold" : ""
          }"
        >
          ${word}
        </span>`;
  ...
  return (
    <div
      ref={containerRef}
      className="relative z-[1] w-full  h-[250px] cursor-pointer text-center pt-8 overflow-hidden"
